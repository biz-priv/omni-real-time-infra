...
sqs_queue_name              = ["omni-wt-rt-shipper-queue-dev","omni-wt-rt-consignee-queue-dev","omni-wt-rt-shipment-milestone-queue-dev","omni-wt-rt-shipment-apar-queue-dev","omni-wt-rt-references-queue-dev","omni-wt-rt-shipment-header-queue-dev","omni-wt-rt-apar-failure-queue-dev"]
sqs_deadletter_queue_name   = ["omni-wt-rt-shipper-DLQ-dev","omni-wt-rt-consignee-DLQ-dev","omni-wt-rt-shipment-milestone-DLQ-dev","omni-wt-rt-shipment-apar-DLQ-dev","omni-wt-rt-references-DLQ-dev","omni-wt-rt-shipment-header-DLQ-dev","omni-wt-rt-apar-failure-DLQ-dev"]
