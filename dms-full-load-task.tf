  ...
  table_mappings = jsonencode(
    {
      "rules" : [
        ...
        },
        {
          ...
          "object-locator" : {
            "schema-name" : "dbo",
            "table-name" : "tbl_ConfirmationCost"
          },
          "rule-action" : "include",
          "filters" : []
        },
        {
          ...
          "object-locator" : {
            "schema-name" : "dbo",
            "table-name" : "tbl_ConsolStopHeaders"
          },
          "rule-action" : "include",
          "filters" : []
        },
        {
          ...
          "object-locator" : {
            "schema-name" : "dbo",
            "table-name" : "tbl_ConsolStopItems"
          },
          "rule-action" : "include",
          "filters" : []
        },
...
resource "aws_dms_replication_task" "omni-wt-rt-header-fullload-rateFile-dms-task" {
  migration_type           = "full-load"
  replication_instance_arn = aws_dms_replication_instance.omni-wt-rt-updates-dms-instance.replication_instance_arn
  replication_task_id      = "omni-wt-rt-header-fullload-rateFile-${var.env}"
  replication_task_settings = jsonencode(
    {
      "TargetMetadata" : {
        "TargetSchema" : "",
